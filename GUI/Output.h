...
public:
	...
	void deletetoolbar() const;     //clear the tool Bar
	...
	void DrawLed(GraphicsInfo r_GfxInfo, bool selected = false, bool lit = false) const;
	void DrawComponentLabel(const GraphicsInfo& r_GfxInfo, const string& label) const;
	///TODO: Make similar functions for drawing all other gates, switch, and LED, .. etc

	// Draws Connection
	void DrawConnection(GraphicsInfo r_GfxInfo, bool selected = false, bool straight = false) const;

	void PrintMsg(string msg) const;	//Print a message on Status ba
